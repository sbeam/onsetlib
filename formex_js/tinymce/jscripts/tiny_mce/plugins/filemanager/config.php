<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,refresh,upload,rename,cut,copy,paste,delete,view,download,insert,addfavorite,removefavorite";
	...
	$mcFileManagerConfig['filesystem.path'] = VISYCS_FILEMANAGER_ROOTPATH; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = VISYCS_FILEMANAGER_ROOTPATH; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.datefmt'] = "d M Y H:i";
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,fla";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,fla,flv,mov,asf,wma,wmv";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,fla,flv,mov,asf,wma,wmv";
	...
	// Authenication
	$mcFileManagerConfig['authenticator'] = "vzxSessionAuthenticator";
	$mcFileManagerConfig['authenticator.login_page'] = "notallowed.php";
	$mcFileManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "tinymce_login_token";
